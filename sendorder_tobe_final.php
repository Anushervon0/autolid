...
function sendMail($formData, $formType)
{
   ...
   try {
    ...
    $contactFields = prepareContactFields($formData);
         ...
         case 'osago-new-form':
            ...
            $bitrixParams = [
               "fields" => array_merge([
                  ...
                  "UF_CRM_1744632756" => 921,
                  "UF_CRM_1751622893" => 402,
                  "UF_CRM_1744814721142" => $config['landing_href'],
                  "UF_CRM_1744807379192" => $formData['vehicle-vin-number'] ?? '',
                  "UF_CRM_1744632396" => $formData['vehicle-registration-number'] ?? '',
                  "UF_CRM_1744646586" => $newOsagoDrivers,
               ], $contactFields)
            ];
            ...
            if($formData['forma-sobstvennosti'] == 'Юридическое лицо') {
               ...
               $bitrixParams["fields"]["UF_CRM_1781183276"] = ( $formData['owner-last-name'] ?? '' ) ." ". ( $formData['owner-first-name'] ?? '' ) ." ".
                  ( $formData['owner-middle-name'] ?? '' ) .", Дата рождения:". ( $formData['owner-birth-date'] ?? '' );
         ...
         case 'go-form':
            ...
            $bitrixParams = [
               "fields" => array_merge([
                  ...
                  "UF_CRM_1744632756" => 5399,
                  "UF_CRM_1751622893" => 415,
                  "UF_CRM_1744814721142" => $config['landing_href'],
         ...
         case 'property-yurlic-form':
            ...
            $bitrixParams = [
               "fields" => array_merge([
                  ...
                  "UF_CRM_1751622893" => 413,
                  "UF_CRM_1744632756" => 5400,
                  "UF_CRM_1744814721142" => $config['landing_href'],
                  "UF_CRM_1748342798407" => $formData['city'] ?? '',
                  "UF_CRM_1771395881625" => $formData['city'] ?? '',
                  "UF_CRM_1748342715974" => $formData['inn'] ?? '',
         ...
         case 'ipoteka-form':
            ...
            $bitrixParams = [
               "fields" => array_merge([
                  ...
                  "UF_CRM_1744632756" => 894,
                  "UF_CRM_1751622893" => 417,
                  "UF_CRM_1744814721142" => $config['landing_href'],
         ...
         case 'dms-fizlic-form':
            ...
            $bitrixParams = [
               "fields" => array_merge([
                  ...
                  "UF_CRM_1744814721142" => $config['landing_href'],
                  "UF_CRM_1744632756" => 1523,
                  "UF_CRM_1751622893" => 414,
                  "HONORIFIC" => $formData['gender'] == "Мужской" ? "HNR_RU_1" : "HNR_RU_2",
                  "UF_CRM_1748342798407" => $formData['mesto-reg-sobst'],
         ...
         case 'puteshestvie-form':
            ...
            $bitrixParams = [
               "fields" => array_merge([
                  ...
                  "UF_CRM_1744814721142" => $config['landing_href'],
                  "UF_CRM_1744632756" => 1526,
                  "UF_CRM_1751622893" => 405,
                  "UF_CRM_1748342798407" => $formData['city'],
         ...
         case 'gruz-form':
            ...
            $bitrixParams = [
               "fields" => array_merge([
                  ...
                  "UF_CRM_1744814721142" => $config['landing_href'],
                  "UF_CRM_1744632756" => 1552,
                  "UF_CRM_1751622893" => 409,
                  "UF_CRM_1748342798407" => $formData['city'] ?? '',
                  "UF_CRM_1748342715974" => $formData['inn'] ?? '',
         ...
         case 'opo-form':
            ...
            $bitrixParams = [
               "fields" => array_merge([
                  ...
                  "UF_CRM_1744814721142" => $config['landing_href'],
                  "UF_CRM_1744632756" => 5398,
                  "UF_CRM_1751622893" => 416,
                  "UF_CRM_1748342715974" => $formData['inn'] ?? '',
      ...
      if (!empty($_FILES['insurance-policy-img']['name'][0])) {
